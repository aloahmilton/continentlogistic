export const branding = {
  ...
  logo: 'https://continentaltrack.vercel.app/logo.png', // Assuming logo path
};
...
<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #eee; border-radius: 8px; overflow: hidden;">
  <div style="background-color: ${branding.primary}; padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0; font-size: 24px;">Continental Track</h1>
  </div>
  ...
  <div style="background-color: #f9f9f9; padding: 20px; text-align: center; font-size: 12px; color: #666; border-top: 1px solid #eee;">
    &copy; ${new Date().getFullYear()} Continental Track Logistics. All rights reserved.<br>
    Visit us at <a href="https://continentaltrack.com" style="color: ${branding.primary}; text-decoration: none;">continentaltrack.com</a>
  </div>
</div>
`;
...
export const getShipmentCreatedTemplate = (shipment: any) => getBaseTemplate(`
  ...
  <div style="text-align: center; margin: 30px 0;">
    <a href="https://continentaltrack.vercel.app/tracking/${shipment.id}" style="background-color: ${branding.primary}; color: white; padding: 12px 25px; text-decoration: none; border-radius: 4px; font-weight: bold;">Track Shipment</a>
  </div>
  <p>Thank you for choosing Continental Track!</p>
`);
