...
export default function Legal() {
  usePageSEO({ title: "Legal Notice", description: "Continent Logistic.org legal notice — company registration, regulatory information, and legal disclaimers." });
        ...
        <div className="max-w-3xl mx-auto prose prose-sm">
          <ScrollReveal>
            <section className="mb-8">
              ...
              <p className="text-sm text-muted-foreground mb-1">Continent Logistic.org International GmbH</p>
