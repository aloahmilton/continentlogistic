...
export default function FraudAwareness() {
  usePageSEO({ title: "Fraud Awareness", description: "Protect yourself from scams impersonating Continental Track. Learn how to identify fraudulent emails, calls, and websites." });

  return (
    <PageLayout title="Fraud Awareness" breadcrumb={[{ label: "Fraud Awareness" }]} heroSubtitle="Protect yourself from scams that misuse the Continental Track brand.">
          ...
          <ScrollReveal>
            <div className="bg-destructive/5 border border-destructive/20 rounded-lg p-6 mb-8 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Continental Track will never ask for payment via email, text message, or phone to release a shipment. If you receive such a request, it is fraudulent.</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                { icon: Phone, title: "Phone Scams", desc: "Callers impersonating Continental Track demanding fees to release packages. We never call to request advance payment." },
                { icon: Shield, title: "Fake Websites", desc: "Websites mimicking our branding to collect credit card or personal data. Always verify the URL is continentaltrack.com." },
              ].map((f) => (
