...
const sections = [
  { title: "1. Data Controller", content: "Continent Logistic.org International GmbH, Logistics Avenue 1, 10115 Berlin, Germany, is the data controller responsible for the processing of your personal data." },
  ...
  { title: "4. Data Sharing", content: "We share data with Continent Logistic.org group companies, authorized service partners for delivery, customs authorities as required by law, and technology partners operating on our behalf. We do not sell personal data to third parties." },
  ...
  { title: "6. Your Rights", content: "Under GDPR and applicable laws, you have the right to access, rectify, erase, restrict processing, data portability, and object to processing of your personal data. Contact our Data Protection Officer at Continentlogistic01@gmail.com." },
...
export default function Privacy() {
  usePageSEO({ title: "Privacy Notice", description: "Continent Logistic.org privacy notice — how we collect, use, store, and protect your personal data in compliance with GDPR." });
